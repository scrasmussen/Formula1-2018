...
# import race data
fantasy2021 = ['Week','Year','Name','Points','isDriver','GridPosition',
               'FinalResult']
f = pd.read_csv('data/2021_fantasy_points.csv', names=fantasy2021,
                 dtype={'isDriver':bool})
...
cost_data = pd.read_csv('data/2021_cost.csv', names=cost_names)
